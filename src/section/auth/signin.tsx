...
const Signin = () => {
  return (
    <main className='flex w-full'>
      <div className='relative hidden h-screen flex-1 items-center justify-center bg-black lg:flex'>
          ...
          <div className=' mt-16 space-y-3'>
            ...
            <div className='flex items-center -space-x-2 overflow-hidden'>
              ...
              <img
                ...
                className='h-10 w-10 rounded-full border-2 border-white'
              />
              <p className='translate-x-5 text-sm font-medium text-white'>
                Join 5.000+ users
              </p>
            </div>
          </div>
      ...
      <div className='flex h-screen flex-1 items-center justify-center'>
        <div className='w-full max-w-md space-y-8 bg-white px-4 text-gray-600 sm:px-0'>
          ...
          <form className='space-y-5'>
            ...
            <button className='w-full rounded-lg bg-black px-4 py-2 font-medium text-white duration-150 hover:bg-black active:bg-black'>
              Login
            </button>
          </form>
        </div>
